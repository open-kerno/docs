...
A good first stop is the [Phone Number Standards](/docs/phone-number-standards) guide — it is a practical example of how we document a technical decision end to end.
